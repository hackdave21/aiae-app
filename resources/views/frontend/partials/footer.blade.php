      ...
      <div class="grid grid-cols-1 md:grid-cols-[1.6fr_1fr_1fr_1fr] gap-16">
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-600 text-[16px]">
            ...
            <li><a href="#" onclick="openComingSoon(); return false;" class="hover:text-[#1a1f4d] transition">{{ __('Énergie') }}</a></li>
            <li><a href="#" onclick="openComingSoon(); return false;" class="hover:text-[#1a1f4d] transition">{{ __('Sécurité') }}</a></li>
            <li><a href="#" onclick="openComingSoon(); return false;" class="hover:text-[#1a1f4d] transition">{{ __('Préfabrication') }}</a></li>
